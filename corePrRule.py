...
class EquityIndexCalculation:
    ...
    def __init__(self,cl_FileProcessor):
        ...
        self.BankComposition = cl_FileProcessor.dict_FileData["BankComposition"]
...
#        print(self.IndexCalculationDetails.IsRebalance.values[0])
        if self.IndexCalculationDetails.IsRebalance.values[0]:
            newComp = self.BankComposition[~(self.BankComposition.OpenUnitsAdjusted == 0)].InstrumentVTId
#            print(newComp)
...
#            print(self.IndexVTId)
            ...
            for instruments in newCompAdded:
                df_newCompAdded.loc[df_newCompAdded.InstrumentVTId==instruments, "PriceInInstrumentCurrency"] = float(self.BankComposition.loc[self.BankComposition.InstrumentVTId==instruments, "PriceInInstrumentCurrency"])
                df_newCompAdded.loc[df_newCompAdded.InstrumentVTId==instruments, "FxRate"] = float(self.BankComposition.loc[self.BankComposition.InstrumentVTId==instruments, "FxRate"])
    ...
    def fn_rebalCheckOpenComp(self):
        if self.IndexCalculationDetails.IsRebalance.values[0]:
            self.NewOpenComposition.set_index("InstrumentVTId", inplace = True)
            self.BankComposition.set_index("InstrumentVTId", inplace = True)
#            print(self.BankComposition.OpenUnitsAdjusted)
#            print(self.NewOpenComposition.Units)
#            print(self.NewOpenComposition.PriceInInstrumentCurrency*self.NewOpenComposition.PriceAdjustmentFactor)
            self.NewOpenComposition.Units = self.BankComposition.OpenUnitsAdjusted
#            print(self.NewOpenComposition.Units)            
            ...
            self.NewOpenComposition.reset_index(inplace = True)
            self.BankComposition.reset_index(inplace = True)
...
#        print(self.IndexLevel)
    ...
    def fn_IndexCalculationDetails(self):
        ...
        if self.IndexCalculationDetails.IsRebalance.values[0]:
            ...
            print(sum(abs(self.NewCloseComposition["Units"]-self.NewOpenComposition["Units"])))
            print(Fee)
...
#                    print(df_CaWithoutCashDiv)
    ...
    def fn_VTOpenComp(self):
        self.NewOpenComposition = self.NewCloseComposition.copy()
        self.NewOpenComposition.ShareAdjustmentFactor = 1    
...
#        R1=self.Return.loc[(Return["Ticker"]=="JTRDCFXU")&()]
    ...
    def CloseUnits(self):
        Price
        self.TargetExp()*self.IndexNotional()/7*
...
class cl_ProcessMapper:
    ...
    processmapper = {PrNames.genBankComp.value: {SubPrNames.genBankComp_StdCloseComp.value: cl_BankOCClose.fn_Stdclose
                    ...
                    ,PrNames.genCompLevel.value: {SubPrNames.genComp2Level_StdComp2Level.value: cl_Comp2Level.fn_StdComp2Level
