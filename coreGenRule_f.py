...
# -*- coding: utf-8 -*-
"""
Created on Sun Jun 30 18:22:11 2019

@author: tanmaysinghsidhu
"""
...
#        return self.sql_cash_div_except.loc[(self.sql_cash_div_except["EventName"].isin(["Cash Dividend"]))&(self.sql_cash_div_except["CountryCode"].isin(["KR","JP"])),"PayDatePrice_1"]
    ...
    def handling_duplicates(self):
        ...
        for i in list(df_ex.groups):
            if len(df_ex.get_group(i).loc[df_ex.get_group(i)["EventName"].isin(['Cash Dividend'])]) > 0:
                if df_ex.get_group(i).loc[(df_ex.get_group(i)["EventName"].isin(["Cash Dividend"]))&(df_ex.get_group(i)["CountryCode"].isin(["AU"])),"EventName"].count() > 0:
                    ...
                    df_ex.get_group(i).loc[(df_ex.get_group(i)["EventName"].isin(["Cash Dividend"]))&(df_ex.get_group(i)["CountryCode"].isin(["AU"])),"NTR_PriceEx_1"]=aus_adj_price_NTR
                    ...
                    df_ex.get_group(i).loc[(df_ex.get_group(i)["EventName"].isin(["Cash Dividend"]))&(df_ex.get_group(i)["CountryCode"].isin(["AU"])),"GTR_PriceEx_1"]=aus_adj_price_GTR
                    df_ex.get_group(i).loc[df_ex.get_group(i)["CountryCode"].isin(["AU"])&(df_ex.get_group(i)["EventName"].isin(["Cash Dividend"])),"PR(PAF)"]=1
                    df_ex.get_group(i).loc[(df_ex.get_group(i)["EventName"].isin(["Cash Dividend"]))&(df_ex.get_group(i)["CountryCode"].isin(["AU"])),"PR_PriceEx_1"]=au_PriceEx_1*1
                if len(df_ex.get_group(i).loc[(df_ex.get_group(i)["EventName"].isin('Cash Dividend'))&(~df_ex.get_group(i)['CountryCode'].isin(['AU']))]) > 0:
                    ...
                    df_ex.get_group(i).loc[(df_ex.get_group(i)['EventName'].isin(['Cash Dividend']))&(~df_ex.get_group(i)['CountryCode'].isin(['AU'])),"NTR_PriceEx_1"]=adj_price_NTR
                    ...
                    df_ex.get_group(i).loc[(df_ex.get_group(i)['EventName'].isin(['Cash Dividend']))&(~df_ex.get_group(i)['CountryCode'].isin(['AU'])),"PR_PriceEx_1"]=PriceEx_1*1
                if len(df_ex.get_group(i).loc[(df_ex.get_group(i)['EventName'].isin(['Special Dividend']))]) > 0:
                    if df_ex.get_group(i).loc[(df_ex.get_group(i)["EventName"].isin(["Special Dividend"]))&(df_ex.get_group(i)["CountryCode"].isin(["AU"])),"EventName"].count() > 0:
                        GTR_PriceEx_1=df_ex.get_group(i).loc[(df_ex.get_group(i)["EventName"].isin(["Special Dividend"]))&(df_ex.get_group(i)["CountryCode"].isin(["AU"])),"GTR_PriceEx_1"].values[0]    
                        NTR_PriceEx_1=df_ex.get_group(i).loc[(df_ex.get_group(i)["EventName"].isin(["Special Dividend"]))&(df_ex.get_group(i)["CountryCode"].isin(["AU"])),"NTR_PriceEx_1"].values[0]
                        PR_PriceEx_1=df_ex.get_group(i).loc[(df_ex.get_group(i)["EventName"].isin(["Special Dividend"]))&(df_ex.get_group(i)["CountryCode"].isin(["AU"])),"PR_PriceEx_1"].values[0]    
#                        eventamount=df_ex.get_group(i).loc[(df_ex.get_group(i)["EventName"].isin(["Special Dividend"]))&(df_ex.get_group(i)["CountryCode"].isin(["AU"])),"EventAmount"].values[0]
                        au_Fx_1=df_ex.get_group(i).loc[(df_ex.get_group(i)["EventName"].isin(["Special Dividend"]))&(df_ex.get_group(i)["CountryCode"].isin(["AU"])),"FxEx_1"]
                        au_EventAmount=df_ex.get_group(i).loc[(df_ex.get_group(i)["EventName"].isin(["Special Dividend"]))&(df_ex.get_group(i)["CountryCode"].isin(["AU"])),"EventAmount"].sum()
                        df_ex.get_group(i).loc[df_ex.get_group(i)["CountryCode"].isin(["AU"])&(df_ex.get_group(i)["EventName"].isin(["Special Dividend"])),"GTR(PAF)"]=(GTR_PriceEx_1-(au_EventAmount*au_Fx_1))/GTR_PriceEx_1
                        df_ex.get_group(i).loc[df_ex.get_group(i)["CountryCode"].isin(["AU"])&(df_ex.get_group(i)["EventName"].isin(["Special Dividend"])),"NTR(PAF)"]=(NTR_PriceEx_1-(au_EventAmount*au_Fx_1))/NTR_PriceEx_1
                        aus_adj_price_NTR=df_ex.get_group(i).loc[df_ex.get_group(i)["CountryCode"].isin(["AU"])&(df_ex.get_group(i)["EventName"].isin(["Special Dividend"])),"NTR(PAF)"].values[0]*NTR_PriceEx_1
                        df_ex.get_group(i).loc[(df_ex.get_group(i)["EventName"].isin(["Special Dividend"]))&(df_ex.get_group(i)["CountryCode"].isin(["AU"])),"NTR_PriceEx_1"]=aus_adj_price_NTR
                        aus_adj_price_GTR=df_ex.get_group(i).loc[df_ex.get_group(i)["CountryCode"].isin(["AU"])&(df_ex.get_group(i)["EventName"].isin(["Special Dividend"])),"GTR(PAF)"].values[0]*GTR_PriceEx_1
                        df_ex.get_group(i).loc[(df_ex.get_group(i)["EventName"].isin(["Special Dividend"]))&(df_ex.get_group(i)["CountryCode"].isin(["AU"])),"GTR_PriceEx_1"]=aus_adj_price_GTR
                        df_ex.get_group(i).loc[df_ex.get_group(i)["CountryCode"].isin(["AU"])&(df_ex.get_group(i)["EventName"].isin(["Special Dividend"])),"PR(PAF)"]=(au_PriceEx_1-(au_EventAmount*au_Fx_1))/GTR_PriceEx_1
                        aus_adj_price_PR=df_ex.get_group(i).loc[df_ex.get_group(i)["CountryCode"].isin(["AU"])&(df_ex.get_group(i)["EventName"].isin(["Special Dividend"])),"PR(PAF)"].values[0]*PR_PriceEx_1
                        df_ex.get_group(i).loc[(df_ex.get_group(i)["EventName"].isin(["Special Dividend"]))&(df_ex.get_group(i)["CountryCode"].isin(["AU"])),"PR_PriceEx_1"]=aus_adj_price_PR
                    if len(df_ex.get_group(i).loc[(df_ex.get_group(i)["EventName"].isin('Special Dividend'))&(~df_ex.get_group(i)['CountryCode'].isin(['AU']))]) > 0:
                        GTR_PriceEx_1=df_ex.get_group(i).loc[(df_ex.get_group(i)["EventName"].isin(["Special Dividend"]))&(~df_ex.get_group(i)["CountryCode"].isin(["AU"])),"GTR_PriceEx_1"].values[0]    
                        NTR_PriceEx_1=df_ex.get_group(i).loc[(df_ex.get_group(i)["EventName"].isin(["Special Dividend"]))&(~df_ex.get_group(i)["CountryCode"].isin(["AU"])),"NTR_PriceEx_1"].values[0]
                        PR_PriceEx_1=df_ex.get_group(i).loc[(df_ex.get_group(i)["EventName"].isin(["Special Dividend"]))&(~df_ex.get_group(i)["CountryCode"].isin(["AU"])),"PR_PriceEx_1"].values[0]    
#                        eventamount=df_ex.get_group(i).loc[(df_ex.get_group(i)["EventName"].isin(["Special Dividend"]))&(df_ex.get_group(i)["CountryCode"].isin(["AU"])),"EventAmount"].values[0]
...
#        print("hey",self.sql_cash_div_ex_excep.loc[~(self.sql_cash_div_ex_excep["EventName"].isin(["Cash Dividend"])),"EventName"].count())
        ...
        try:
            ...
            if self.sql_cash_div_ex_excep.loc[~(self.sql_cash_div_ex_excep["EventName"].isin(["Cash Dividend"])),"EventName"].count()>0:
                ...
                self.sql_cash_div_ex_excep.loc[~self.sql_cash_div_ex_excep["EventName"].isin(["Cash Dividend"]),"GTR(PAF)"]=(PriceEx_1 -( DividendAmount * FxEx_1))/PriceEx_1
                self.sql_cash_div_ex_excep.loc[~self.sql_cash_div_ex_excep["EventName"].isin(["Cash Dividend"]),"GTR(PAF)"]=(PriceEx_1 -( DividendAmount * FxEx_1))/PriceEx_1
